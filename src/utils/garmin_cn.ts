...
export const migrateGarminCN2GarminGlobal = async (count = 200) => {
    ...
    const runningActs = _.filter(actSlices, act => act.activityType.typeKey === 'running' || act.activityType.typeKey === 'treadmill_running' || act.activityType.typeKey === 'track_running');
